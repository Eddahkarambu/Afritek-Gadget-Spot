...
export default function Contact() {
  ...
  return <div className="editorial-page"><div className="store-container">
    ...
    {!shop.loading && !shop.error && <div className="contact-cards">
      ...
      <section className="information-card"><MapPin size={22} /><h2>Visit our branch</h2><p>{address || 'Contact the shop for location and opening hours before visiting.'}</p>{address && <a href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(address)}`} target="_blank" rel="noreferrer">Find on Google Maps <ArrowUpRight size={16} /></a>}</section>
    </div>}
