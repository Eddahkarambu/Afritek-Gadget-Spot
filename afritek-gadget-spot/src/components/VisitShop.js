...
export default function VisitShop({ productName }) {
  const inquiry = productName ? `/contact?message=${encodeURIComponent(`Hi, I’d like to visit your Bazaar shop to buy ${productName}. Could you confirm availability before I come in?`)}#contact-message` : '/contact';
