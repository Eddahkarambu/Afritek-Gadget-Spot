  ...
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto">
      ...
      <div className="relative max-w-4xl mx-auto">
        {/* Card */}
        <div className="bg-[#111827] rounded-3xl border border-gray-800 hover:border-cyan-500/50 transition-all p-12 md:p-16">
          {/* Stars */}
        ...
        <div className="flex justify-center gap-4 mt-8">
          <button
            onClick={prevSlide}
            className="w-12 h-12 rounded-full border border-gray-700 hover:border-cyan-500 hover:bg-cyan-500/10 flex items-center justify-center text-gray-400 hover:text-cyan-400 transition-all"
          >
            <ChevronLeft size={24} />
          </button>
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="text-center p-6 bg-[#111827] rounded-2xl border border-gray-800 hover:border-cyan-500/30 transition-all">
